...
replace golang.org/x/tools => github.com/golang/tools v0.0.0-20190709211700-7b25e351ac0e
...
replace google.golang.org/genproto => github.com/google/go-genproto v0.0.0-20190708153700-3bdd9d9f5532
